...
Item {
    ...
    onLanguageChanged: {
        ...
        //arrange ciphertext letters
        if (text_frequency_model.count > 0) {
            Caesar.matchModel(text_frequency_model, language_frequency_model, exercise.key, secrettext.getSimpleText(), true)
        }
    }
        ...
        Row {
            ...
            NumberField {
                ...
                onTextChanged: {
                    ...
                    Caesar.matchModel(text_frequency_model, language_frequency_model, keyNum, secrettext.getSimpleText(), true)
                }
            }
        }
    }
